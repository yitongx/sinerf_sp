'''
5.7 for trajectory visualization
'''
import sys
import os
import argparse
...
def main(args):
    ...
    # ax.plot(plt_est_origins[:, 0], plt_est_origins[:, 1], plt_est_origins[:, 2], 'b-^', zdir='z')
    # ax.plot(plt_colmap_origins[:, 0], plt_colmap_origins[:, 1], plt_colmap_origins[:, 2], 'm-^', zdir='z')
